...
export class RegistroAgenciaDigitalComponent implements OnInit {
  ...
  ngOnInit () {
    ...
    this.form_03 = new FormGroup ({
      ...
      canales_opera: new FormControl ('', [Validators.required, Validators.max (20), Validators.min (1)]),
      ...
      cond_min_cd_13: new FormControl (false, Validators.compose([ Validators.required, Validators.pattern('true')])),
      cond_min_cd_14: new FormControl (false, Validators.compose([ Validators.required, Validators.pattern('true')])),
    });
  ...
  check_cd_value () {
    if (this.form_03.value.cond_min_cd_13 === false && this.form_03.value.cond_min_cd_14 === false) {
      this.form_03.controls ['cond_min_cd_13'].setValidators ([Validators.compose([ Validators.required, Validators.pattern('true')])]);
      this.form_03.controls ['cond_min_cd_14'].setValidators ([Validators.compose([ Validators.required, Validators.pattern('true')])]);
    } else if (this.form_03.value.cond_min_cd_13 === true && this.form_03.value.cond_min_cd_14 === false) {
      this.form_03.controls ['cond_min_cd_14'].setValidators ([]);
    } else if (this.form_03.value.cond_min_cd_14 === true && this.form_03.value.cond_min_cd_13 === false) {
      this.form_03.controls ['cond_min_cd_13'].setValidators ([]);
    }

    this.form_03.controls ['cond_min_cd_13'].updateValueAndValidity ();
    this.form_03.controls ['cond_min_cd_14'].updateValueAndValidity ();
  }
  ...
  async validar_ruc (dialog: any) {
    this.esta_validando = true;
    if (await this.database.is_ruc_valid (this.form_01.value.representante_ruc) === undefined) {
      this.cambiar_vista (+1);
      this.esta_validando = false;
    } else {
      this.dialog.open (dialog);
  ...
  check_numero_certificado_value (event: any) {
    if (event) {
      this.form_04.controls ['turismo_aventura_certificado'].setValidators ([Validators.required, Validators.pattern ('^[0-9|-]*$')]);
    } else {
      this.form_04.controls ['turismo_aventura_certificado'].setValidators ([]);
    }

    this.form_04.controls ['turismo_aventura_certificado'].updateValueAndValidity ();
  }

  validar_transporte () {
    if (this.form_06.value.trans_terres === true || this.form_06.value.trans_acuatico === true || this.form_06.value.trans_arere === true) {
      this.form_06.controls ['nro_unidades_sericio'].setValidators ([Validators.required]);
      this.form_06.controls ['nro_placas_transporte'].setValidators ([Validators.required]);
    } else {
      this.form_06.controls ['nro_unidades_sericio'].setValidators ([]);
      this.form_06.controls ['nro_placas_transporte'].setValidators ([]);
    }

    this.form_06.controls ['nro_unidades_sericio'].updateValueAndValidity ();
    this.form_06.controls ['nro_placas_transporte'].updateValueAndValidity ();
  }
  ...
  documentoChanged (value: string) {
    ...
    if (value === 'DNI') {
      this.form_01.controls ['representante_ndoc'].setValidators ([
        Validators.required,
    ...
    this.form_01.controls ['representante_ndoc'].updateValueAndValidity ();
  }
}
